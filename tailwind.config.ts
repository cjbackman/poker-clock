...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'poker-pattern':
          "url('data:image/svg+xml;base64,')",
      ...
      boxShadow: {
        ...
        button: '0 1px 3px rgba(0, 0, 0, 0.3), 0 1px 2px rgba(0, 0, 0, 0.4)',
        'button-hover': '0 3px 6px rgba(0, 0, 0, 0.35), 0 3px 6px rgba(0, 0, 0, 0.4)',
      },
    },
  },
